...
import { getFirestore, collection, doc, getDocs, updateDoc, onSnapshot, setDoc, deleteDoc } from "https://www.gstatic.com/firebasejs/10.8.1/firebase-firestore.js";

// আপনার ফায়ারবেস কনসোল থেকে এই কনফিগ কোডটি কপি করে এখানে বসাবেন
...
window.db = db;
window.fbFirestore = { collection, doc, getDocs, updateDoc, onSnapshot, setDoc, deleteDoc };